...
INSERT INTO "new_knowledge_notes" ("content_hash", "directory_path", "file_name", "frontmatter_json", "has_callouts", "has_dataview", "has_embeds", "has_frontmatter", "has_tasks", "has_wikilinks", "id", "indexed_at", "is_moc", "modified_at", "relative_path", "size_bytes", "vault_id") SELECT "content_hash", "directory_path", "file_name", "frontmatter_json", "has_callouts", "has_dataview", "has_embeds", "has_frontmatter", "has_tasks", "has_wikilinks", "id", "indexed_at", "is_moc", "modified_at", "relative_path", "size_bytes", "vault_id" FROM "knowledge_notes";
