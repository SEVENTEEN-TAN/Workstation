import { BarChart3, BriefcaseBusiness, FileJson, ImagePlus, Newspaper, Target, type LucideIcon } from "lucide-react";

export type AdminNavId = "overview" | "home" | "okr" | "activities" | "projects" | "media";
